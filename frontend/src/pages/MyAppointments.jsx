          ...
          >
            ...
            <div className='flex-1 text-sm text-zinc-600'>
              ...
              <p className='text-xs mt-1'>
                ...
                July 25, 2025 | 8:30 PM
              </p>
            </div>
            <div></div>
            <div className='flex flex-col gap-2 justify-end'>
              <button className='text-sm text-stone-500 text-center sm:min-w-48 py-2 border rounded hover:bg-[#5f6fff] hover:text-white transition-all duration-500'>
                Pay Online
              </button>
