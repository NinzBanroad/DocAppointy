  ...
  return (
    <div className='flex items-center justify-between text-sm py-4 mb-2'>
      ...
      <ul className='hidden md:flex items-start gap-5 font-medium'>
        ...
        <NavLink to='/doctors'>
          <li className='py-1 font-semibold hover:text-[#5f6fff]'>
            ALL DOCTORS
          </li>
          <hr className='border-none outline-none h-0.5 bg-[#5f6fff] w-3/5 m-auto hidden' />
        </NavLink>
      ...
      <div className='flex items-center gap-4'>
        {userToken && userData ? (
          <div className='flex items-center gap-2 cursor-pointer group relative'>
            <img className='w-7 h-7 rounded-full' src={userData.image} alt='' />
        ...
        >
          <div className='flex items-center justify-between px-5 py-6'>
            <img className='w-36' src={assets.docappointy_logo} alt='' />
            <img
              className='w-7'
          ...
          <ul className='flex flex-col items-center gap-2 mt-5 px-5 text-lg font-medium'>
            <NavLink onClick={() => showMenu(false)} to='/'>
